def zombie_adventure():
    ...
    choice = make_choice("Quel couloir choisissez-vous ? (1/2) : ", ["Explorer le couloir de gauche", "Courir vers le couloir de droite"])
    ...
    if choice == 1:
        ...
        second_choice = make_choice("Votre choix ? (1/2) : ", ["Enquêter sur le bruit", "Rester caché et silencieux"])
    ...
    if health <= 0:
        ...
        final_choice = make_choice("Votre choix ? (1/2/3) : ", ["Chercher d'autres survivants", "Trouver un abri permanent", "Explorer d'autres zones"])
